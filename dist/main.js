...
/***/ "./src/app/services/loader-interceptor/loader-interceptor.service.ts":
/*!***************************************************************************!*\
  !*** ./src/app/services/loader-interceptor/loader-interceptor.service.ts ***!
  \***************************************************************************/
...
/* harmony import */ var _loader_loader_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../loader/loader.service */ "./src/app/services/loader/loader.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoaderInterceptorService = /** @class */ (function () {
    ...
    LoaderInterceptorService = __decorate([
        ...
        __metadata("design:paramtypes", [_loader_loader_service__WEBPACK_IMPORTED_MODULE_3__["LoaderService"]])
...
var OrdersService = /** @class */ (function () {
    ...
    OrdersService.prototype.updateOrder = function (access_token, order) {
        ...
        return this.http.put(_config__WEBPACK_IMPORTED_MODULE_2__["url_api"] + this.endpoint + '/' + order.id, data, {
            headers: {
                'Accept': 'application/json',
                'Authorization': 'Bearer ' + access_token,
...
module.exports = __webpack_require__(/*! /home/uesley/Documentos/Projects/Pandeco/pandeco_admin/pandeco-admin/src/main.ts */"./src/main.ts");
