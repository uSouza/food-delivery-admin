...
var MenusShowComponent = /** @class */ (function () {
        ...
        this.modalService
            ...
            if (result == 'delete') {
                _this.menusService
                    ...
                    .subscribe(function (menu) { _this.router.navigate(['/menus-list', { message: 'Menu inativado com sucesso!' }]); }, function (err) { _this.showAlert('danger', err); });
            }
        });
    };
    ...
    MenusShowComponent.prototype.restoreMenu = function (menu) {
        ...
        this.menusService
            ...
            .subscribe(function (res) { return _this.router.navigate(['/menus-list', { message: 'Menu reativado com sucesso!' }]); });
    };
